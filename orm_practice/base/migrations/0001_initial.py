    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant_type', models.CharField(choices=[('IN', 'Indian'), ('IT', 'Italian'), ('CH', 'Chinese'), ('MX', 'Mexican'), ('AM', 'American'), ('JP', 'Japanese'), ('FR', 'French'), ('TH', 'Thai'), ('GR', 'Greek'), ('FF', 'Fast Food'), ('OT', 'Other')], default='OT', max_length=2)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sales', to='base.restaurant')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='staff',
            name='restaurants',
            field=models.ManyToManyField(through='base.StaffRestaurant', to='base.restaurant'),
        ),
    ]
